...
from src.utils.page_image import extract_page_text_for_annotation, render_page_for_annotation

ANNOTATION_PROMPT = """你是专业的学术文档批注助手。请仔细分析这张页面图片（PDF 页或 PPT 幻灯片），用中文生成简洁、专业的批注。
...
class VisionAnnotationService:
    ...
    def annotate_page_from_pdf(
        ...
        """从 PDF 或 PPT 页面生成批注（PPT 会先转为幻灯片图片）"""
